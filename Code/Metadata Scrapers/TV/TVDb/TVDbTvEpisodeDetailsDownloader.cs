...
// ReSharper restore CheckNamespace
{
    class TVDbTvEpisodeDetailsDownloader
    {
        ...
        internal static void DownloadSeriesInformation
            (IMLItem item, string parentDir,
            ...
            bool isUNC, TVDBLib tvdb,string mdfSettingsb, IBaseSystem iBaseSystem )
        {
            ...
            TVdbTvEpisodeDetailsDownloaderHelpers
                .NormalizeSeriesName(ref seriesName);


            if (TVdbTvEpisodeDetailsDownloaderHelpers
                .GetSeriesMatchFromSectionOrTVDb
                (item, ref seriesName, out seriesID,
                tvdb, mdfSettingsb, iBaseSystem, 
                out foundSeries))
                return;
